...
{ JOB_ARTIFICER, {
    ...
    { SP_DEEP_DWARF, SP_HALFLING, SP_KOBOLD, SP_SPRIGGAN, SP_BASE_DRACONIAN,
      SP_DEMONSPAWN, },
    { "dagger", "animal skin", "wand of flame charges:15",
...
{ JOB_BRIGAND, {
    ...
    { SP_TROLL, SP_HALFLING, SP_SPRIGGAN, SP_DEMONSPAWN, SP_VAMPIRE,
      SP_VINE_STALKER, },
    { "dagger plus:2", "cloak", "dart ego:poisoned q:8",
      "dart ego:curare q:2" },
    WCHOICE_NONE,
...
{ JOB_ENCHANTER, {
    ...
    { "dagger plus:1", "book of Maledictions" },
    WCHOICE_NONE,
...
{ JOB_FIGHTER, {
    ...
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_TROLL, SP_MINOTAUR, SP_GARGOYLE,
      SP_CENTAUR, },
    { "ring mail", "kite shield", "potion of might" },
    WCHOICE_PLAIN,
...
{ JOB_GLADIATOR, {
    ...
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_MERFOLK, SP_MINOTAUR, SP_GARGOYLE,
      SP_CENTAUR, },
    { "animal skin", "helmet", "throwing net q:3" },
    WCHOICE_PLAIN,
...
{ JOB_HUNTER, {
    ...
    { "dagger", "animal skin" },
    WCHOICE_RANGED,
    { { SK_FIGHTING, 3 }, { SK_DODGING, 3 }, { SK_STEALTH, 2 },
      { SK_WEAPON, 2 }, },
} },
...
{ JOB_MONK, {
    ...
    { "dagger" },
    WCHOICE_NONE,
    { { SK_FIGHTING, 3 }, { SK_UNARMED_COMBAT, 3 }, { SK_DODGING, 3 },
      { SK_STEALTH, 2 }, },
} },
...
{ JOB_SKALD, {
    ...
    { "dagger", "animal skin", "book of Battle" },
    WCHOICE_NONE,
...
{ JOB_WARPER, {
    ...
    { SP_FELID, SP_HALFLING, SP_DEEP_DWARF, SP_SPRIGGAN, SP_CENTAUR,
      SP_BASE_DRACONIAN, },
    { "dagger", "animal skin", "book of Spatial Translocations", "scroll of blinking",
